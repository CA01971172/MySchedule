...
export default class AppUser {
    ...
    private static readonly serverAddress: string = "https://myschedule-server.iti2022kawahara.com"
    ...
    public static async signUp(redirectLink?: string):Promise<void>{//サインアップするメソッド
        try {
            ...
            if(authState){
                ...
                // TODO サーバーが復旧したら、email登録処理も復活させる
            }
    ...
    public static async deleteUser(): Promise<void> {
        try{
            ...
            // TODO サーバーが復旧したら、email削除処理も復活させる
            const auth = getAuth();
