...
* `public async readData(url: string, id?: string): Promise<object>`
...
* `public async updateData(url: string, data: object, id: string): Promise<void>`
...
* `public async deleteData(url: string, id: string): Promise<void>`
